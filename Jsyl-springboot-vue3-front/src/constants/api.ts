...
/** 系统设置API路径 */
export const API_ADMIN_SYSTEM_SETTINGS = `${API_ADMIN_PATH}/system/settings`;

/** 操作日志列表API路径 */
export const API_ADMIN_LOGS_LIST = `${API_ADMIN_PATH}/logs/list`;

/** 操作日志详情API路径 */
export const API_ADMIN_LOGS_DETAIL = `${API_ADMIN_PATH}/logs`;

/** 清空操作日志API路径 */
export const API_ADMIN_LOGS_CLEAR = `${API_ADMIN_PATH}/logs/clear`;
